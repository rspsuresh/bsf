	...
	public function responseEntryAction(){
		...
		if($this->getRequest()->isXmlHttpRequest())	{
			...
			try {
				...
				echo	$rfvtransStatement = $sql->getSqlStringForSqlObject($rfqvtransInsert); die;
		...
		$select->from('VM_RFQRegister')
			   ->columns(array('RFQRegId', 'RFQNo','TechVerification','Submittal'))
