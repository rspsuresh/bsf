function helpLoader() {
	...
	var enjoyhint_script_steps = [
		{
			"next #hint-step1": 'Hello, I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step2": 'Hello,Flarexrider mugesh I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step3": 'Hello, I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step4": 'Hello,Flarexrider mugesh I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step5": 'Hello, I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step6": "You can select different blocks. For example, let's select title.<br>" +
		...
		{
			"next #hint-step7": 'Hello,Flarexrider mugesh I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
			"next #hint-step8": 'Hello, I\'d like to tell you about EnjoyHint.<br> Click "Next" to proceed.'
		},
		{
